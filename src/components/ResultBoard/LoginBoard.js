...
import { getGenerateProgress, getTaskDetail, generateDetail, selectCandidate, login } from '../../net'
		...
		<form className={style.colHead} onSubmit={handleSubmit}>
			<div className={style.colInner}>
                <div className={style.emailCon}>
                    ...
                    <input
                        className={`${style.iptArea} ${isEmailError ? style.inputError : ''}`}
                        value={email}
                ...
                <div className={style.passwordCon}>
                    ...
                    <input type="password"                         
                        className={`${style.iptArea} ${isPasswordError ? style.inputError : ''}`}
                        value={password}
